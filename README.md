A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Campaign Queue
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-campaign-queue-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Campaign Queue"
